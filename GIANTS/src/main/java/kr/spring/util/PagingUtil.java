...
public class PagingUtil {
	...
	public PagingUtil(String keyfield, String keyword, int currentPage, int count, int rowCount, int pageCount,String pageUrl,String addKey) {
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				page.append("&nbsp;<b><span style='color:#052345;'>"); 
				page.append(i);
				page.append("</span></b>");
			} else {
