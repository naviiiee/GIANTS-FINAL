...
<div class="mypage-form">
		...
		<h2>결제 정보</h2>
			...
			<p class="mypage-bottom">
			<input type="button" value="뒤로가기" class="default-btn" onclick="location.href='${pageContext.request.contextPath}/member/compMypageFoodList.do'">
			</p>
		</div>
	</div>
	<!-- 내용물 끝 -->		
