...
<div class="page-main">
	<div class="main-title">
		...
		<div class="title01">
			<h2 style="margin-right:5%"><a href="playerList_c.do" style="color:black;">선수 소개  [코치]</a></h2>
	...
	<div>
	<form action="playerList_c.do" id="search_form" method="get"  style="padding-bottom: 24px;">
	...
	<c:if test="${count > 0}">
		<table class="striped-table">
			...
			<c:forEach var="player" items="${list}">
				<c:if test="${player.player_position == '코치'}">
					<tr>
