...
<div class="page-main">
	<div class="main-title">
		...
		<div class="title01">
			<h2 style="margin-right:5%"><a href="playerList_w.do" style="color:black;">선수 소개  [외야수]</a></h2>
	...
	<div class="aaa">
		 <div class="dropdown">
	        <button class="dropdown-btn"><img src="${pageContext.request.contextPath}/images/아래화살표.png">외야수</button>
	        <div class="dropdown-submenu">
	            ...
	            <a href="playerList_n.do" class="over">내야수</a>
	   	 </div>
    </div>
	<div>
	<form action="playerList_w.do" id="search_form" method="get"  style="padding-bottom: 24px;">
	...
	<c:if test="${count > 0}">
		<table class="striped-table">
			...
			<c:forEach var="player" items="${list}">
				<c:if test="${player.player_position == '외야수'}">
					<tr>
