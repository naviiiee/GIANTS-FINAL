		...
		<div class="top-menu">
			<ul class="float-right margin-zero">
				...
				<c:if test="${!empty user && user.mem_auth == 2}">
					...
					<li class="top-menu-chat"><a href="${pageContext.request.contextPath}/chat/chatList.do"><img id="chat" src="${pageContext.request.contextPath}/images/speech-bubble.png"></a></li> 
				</c:if>
