		...
		$.ajax({
			...
			success:function(param){
				if(param.result == 'logout'){
					...
					open('../chat/chatting.do?chatroom_num='+param.chatroom_num,'chat','toolbar=no,location=no,status=no,menubar=no,resizable=no,scrollbars=no,width=800,height=800');
				}else{
					alert('채팅방 생성 오류');
				}
			},
